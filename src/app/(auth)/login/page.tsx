...
const DEMO_ACCOUNTS = [
  { email: "parent@nestianannies.com", username: "sarah_johnson_demo", password: "Demo@1234", role: "parent", firstName: "Sarah" },
  { email: "delor963@mailinator.com", username: "delor963", password: "Demo@1234", role: "parent", firstName: "Demo" },
];
...
export default function ParentLogin() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (acct) {
        localStorage.setItem("nestia_user", JSON.stringify({ id: "u1", email: acct.email, role: acct.role, firstName: acct.firstName }));
        router.push("/parent/dashboard");
      } else {
        setError("Invalid credentials. Demo: sarah_johnson_demo / Demo@1234");
        setLoading(false);
      }
    }, 600);
  };
      ...
      <div className="account-inner">
        <div className="account-inner__left">
          <div className="account-thumb">
            <img src="/assets/images/frontend/login/parent_login.jpg" alt="Parent Login" style={{width:"100%",height:"100%",objectFit:"cover"}} />
          </div>
        </div>
        <div className="account-inner__right">
          <div className="account-form-wrapper">
            ...
            <div className="account-login-wrapper">
              <Link href="/login" className="account-login-wrapper-btn active">Login as Parent</Link>
              <Link href="/nanny/login" className="account-login-wrapper-btn">Login as Nannie</Link>
            </div>
            <h4 className="account-form__title">Welcome back</h4>
            <h3 className="account-form__heading">Sign In Account</h3>
            ...
            <form className="account-form" onSubmit={handleSubmit}>
              ...
              <div className="d-flex justify-content-between align-items-center gap-3 mb-4">
                <div className="form-check form--check">
                  ...
                  <label className="form-check-label" htmlFor="rem" style={{whiteSpace:"nowrap"}}>Remember Me</label>
                </div>
            ...
            <div className="mt-3 p-3 rounded" style={{background:"#f8f9fa",fontSize:"12px",border:"1px solid #e2e8f0"}}>
              <strong>Demo Account:</strong><br/>Username: <code>sarah_johnson_demo</code><br/>Password: <code>Demo@1234</code>
            </div>
            <p className="text-center mt-3">Don&apos;t have an account? <Link href="/register" className="text--base">Create Account</Link></p>
          </div>
        </div>
      </div>
    </section>
