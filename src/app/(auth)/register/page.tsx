      ...
      <div className="account-inner">
        <div className="account-inner__left">
          <div className="account-thumb">
            <img src="/assets/images/frontend/login/parent_register.jpg" alt="Register" style={{width:"100%",height:"100%",objectFit:"cover"}} />
          </div>
        </div>
        <div className="account-inner__right">
          <div className="account-form-wrapper">
            ...
            <h3 className="account-form__heading">Create Account</h3>
              ...
              <div className="row g-3">
                ...
                <div className="col-12">
                  <div className="form-check form--check">
                    ...
                    <label className="form-check-label" htmlFor="agree">I agree to the <Link href="/terms" className="text--base">Terms of Service</Link></label>
                  </div>
                </div>
                <div className="col-12">
                  <button type="submit" className="btn btn--base w-100" onClick={(e)=>{
                e.preventDefault();
                const form = e.currentTarget.closest("form");
                if(!form) return;
                // Store pending parent - requires admin email verification
                const userData = {
                ...
                localStorage.setItem("nestia_pending_registration", JSON.stringify(userData));
                window.location.href = "/register/pending";
              }}>Create Account</button>
                </div>
              </div>
            </form>
            <p className="text-center mt-3">Already have an account? <Link href="/login" className="text--base">Sign In</Link></p>
          </div>
        </div>
      </div>
    </section>
